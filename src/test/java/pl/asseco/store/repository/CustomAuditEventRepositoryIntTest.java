package pl.asseco.store.repository;

import pl.asseco.store.StoreApp;
import pl.asseco.store.config.Constants;
import pl.asseco.store.config.audit.AuditEventConverter;
import pl.asseco.store.domain.PersistentAuditEvent;
...
import static pl.asseco.store.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
